...
// Botón de CV (placeholder)
const cvBtn = document.getElementById('cv-btn');
if (cvBtn) {
  cvBtn.addEventListener('click', (e)=>{
    // Si no hay archivo real, prevenimos la navegación y mostramos aviso
    if (cvBtn.getAttribute('href') === '#') {
      e.preventDefault();
      alert('CV no disponible aún. Reemplaza el enlace del botón con tu archivo PDF cuando lo tengas.');
    }
  });
}
...
// AOS simple (sin librería): observa elementos con [data-aos]
